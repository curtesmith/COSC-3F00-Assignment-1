...
${OBJECTDIR}/NewLinkedList.o: NewLinkedList.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/NewLinkedList.o NewLinkedList.cpp
...
${OBJECTDIR}/TestHelper.o: TestHelper.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/TestHelper.o TestHelper.cpp
...
${TESTDIR}/tests/NewLinkListTestsRunner.o: tests/NewLinkListTestsRunner.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} $@.d
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF $@.d -o ${TESTDIR}/tests/NewLinkListTestsRunner.o tests/NewLinkListTestsRunner.cpp


${TESTDIR}/tests/NewLinkedListTests.o: tests/NewLinkedListTests.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} $@.d
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF $@.d -o ${TESTDIR}/tests/NewLinkedListTests.o tests/NewLinkedListTests.cpp
...
${TESTDIR}/tests/PointerTests.o: tests/PointerTests.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} $@.d
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF $@.d -o ${TESTDIR}/tests/PointerTests.o tests/PointerTests.cpp


${TESTDIR}/tests/PointerTestsRunner.o: tests/PointerTestsRunner.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} $@.d
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF $@.d -o ${TESTDIR}/tests/PointerTestsRunner.o tests/PointerTestsRunner.cpp
...
${OBJECTDIR}/NewLinkedList_nomain.o: ${OBJECTDIR}/NewLinkedList.o NewLinkedList.cpp 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/NewLinkedList_nomain.o NewLinkedList.cpp;\
	else  \
...
${OBJECTDIR}/TestHelper_nomain.o: ${OBJECTDIR}/TestHelper.o TestHelper.cpp 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/TestHelper_nomain.o TestHelper.cpp;\
	else  \
